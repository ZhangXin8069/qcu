...
namespace qcu
{
  ...
  template __global__ void cg_give_b__o<double>(void *device_b__o, void *device_b_o,
                                                void *device_vec0, double kappa,
                                                void *device_vals);
  template __global__ void cg_give_r<double>(void *device_r, void *device_b__o, void *device_vec1,
                                             void *device_vals);
  template __global__ void cg_give_dest_o<double>(void *device_dest_o, void *device_src_o,
  ...
  template __global__ void cg_give_p<double>(void *device_p, void *device_r_tilde,
                                             void *device_vals);
  template __global__ void cg_give_x_o<double>(void *device_x_o, void *device_p,
                                               void *device_vals);
  ...
  template __global__ void cg_give_b_o<float>(void *device_b_o, void *device_ans_o,
                                              void *device_vec1, float kappa, void *device_vals);
  template __global__ void cg_give_b__o<float>(void *device_b__o, void *device_b_o,
                                               void *device_vec0, float kappa,
                                               void *device_vals);
  template __global__ void cg_give_r<float>(void *device_r, void *device_b__o, void *device_vec1,
                                            void *device_vals);
  template __global__ void cg_give_dest_o<float>(void *device_dest_o, void *device_src_o,
  ...
  template __global__ void cg_give_p<float>(void *device_p, void *device_r_tilde,
                                            void *device_vals);
  template __global__ void cg_give_x_o<float>(void *device_x_o, void *device_p,
                                              void *device_vals);
