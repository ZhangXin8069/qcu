...
void mpiDslashQcu(void *fermion_out, void *fermion_in, void *gauge, QcuParam *param,
              int parity, QcuParam *grid)
{
  ...
  dim3 blockDim(BLOCK_SIZE);
  {
    ...
    auto start = std::chrono::high_resolution_clock::now();
      // clean
      wilson_dslash_clear_dest<<<gridDim, blockDim>>>(fermion_out, lat_1dim[X], lat_1dim[Y],
                                                      lat_1dim[Z]);
      // send x
      wilson_dslash_x_send<<<gridDim, blockDim>>>(gauge, fermion_in, fermion_out, lat_1dim[X],
      ...
      // send y
      wilson_dslash_y_send<<<gridDim, blockDim>>>(gauge, fermion_in, fermion_out, lat_1dim[X],
                                                  lat_1dim[Y], lat_1dim[Z], lat_1dim[T], parity,
      ...
      // send z
      wilson_dslash_z_send<<<gridDim, blockDim>>>(gauge, fermion_in, fermion_out, lat_1dim[X],
                                                  lat_1dim[Y], lat_1dim[Z], lat_1dim[T], parity,
      ...
      // send t
      wilson_dslash_t_send<<<gridDim, blockDim>>>(gauge, fermion_in, fermion_out, lat_1dim[X],
                                                  lat_1dim[Y], lat_1dim[Z], lat_1dim[T], parity,
      ...
      if (grid_1dim[X] != 1)
      {
        ...
        wilson_dslash_x_recv<<<gridDim, blockDim>>>(gauge, fermion_out, lat_1dim[X], lat_1dim[Y],
      ...
      if (grid_1dim[Y] != 1)
      {
        ...
        wilson_dslash_y_recv<<<gridDim, blockDim>>>(gauge, fermion_out, lat_1dim[X], lat_1dim[Y],
                                                    lat_1dim[Z], lat_1dim[T], parity,
      ...
      if (grid_1dim[Z] != 1)
      {
        ...
        wilson_dslash_z_recv<<<gridDim, blockDim>>>(gauge, fermion_out, lat_1dim[X], lat_1dim[Y],
                                                    lat_1dim[Z], lat_1dim[T], parity,
      ...
      if (grid_1dim[T] != 1)
      {
        ...
        wilson_dslash_t_recv<<<gridDim, blockDim>>>(gauge, fermion_out, lat_1dim[X], lat_1dim[Y],
                                                    lat_1dim[Z], lat_1dim[T], parity,
