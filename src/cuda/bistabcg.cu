...
__global__ void bistabcg_give_b_e(void *device_b_e, void *device_ans_e,
  ...
  if (idx < lat_4dim) {
    ...
    LatticeComplex *latt_tmp0 = static_cast<LatticeComplex *>(device_tmps0);
...
__global__ void bistabcg_give_b_o(void *device_b_o, void *device_ans_o,
  ...
  if (idx < lat_4dim) {
    ...
    LatticeComplex *latt_tmp1 = static_cast<LatticeComplex *>(device_tmps1);
    for (int i = 0; i < _LAT_SC_; ++i) {
      b_o[idx * _LAT_SC_ + i] =
...
__global__ void bistabcg_give_dest_o(void *device_dest_o,
                                            void *device_src_o,
                                            void *device_tmps1,
                                            double kappa) {
  int idx = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void bistabcg_give_p(void *device_p, void *device_r,
...
__global__ void bistabcg_give_s(void *device_s, void *device_r,
...
__global__ void bistabcg_give_r(void *device_r, void *device_s,
