  ...
  {   // x part
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        for (int c1 = 0; c1 < _LAT_C_; c1++) {
          tmp0 += (src[c1] + src[c1 + _LAT_3C_].multi_i()) *
                  U[c1 * _LAT_C_ + c0].conj();
          tmp1 += (src[c1 + _LAT_1C_] + src[c1 + _LAT_2C_].multi_i()) *
                  U[c1 * _LAT_C_ + c0].conj();
        }
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp1.multi_i(_negative_, dag, true);
        dest[c0 + _LAT_3C_] += tmp0.multi_i(_negative_, dag, true);
      }
    }
    {
      // x+1
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        for (int c1 = 0; c1 < _LAT_C_; c1++) {
          tmp0 +=
              (src[c1] - src[c1 + _LAT_3C_].multi_i()) * U[c0 * _LAT_C_ + c1];
          tmp1 += (src[c1 + _LAT_1C_] - src[c1 + _LAT_2C_].multi_i()) *
                  U[c0 * _LAT_C_ + c1];
        }
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp1.multi_i(_positive_, dag, true);
        dest[c0 + _LAT_3C_] += tmp0.multi_i(_positive_, dag, true);
      }
    }
  }
#endif
  ...
  {   // y part
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_3C_] += tmp0.multi_i(_negative_, dag, false);
      }
    }
    {
      // y+1
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp1.multi_i(_negative_, dag, false);
        dest[c0 + _LAT_3C_] += tmp0.multi_i(_positive_, dag, false);
      }
    }
  }
#endif
  ...
  {   // z part
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        tmp1.zero();
        for (int c1 = 0; c1 < _LAT_C_; c1++) {
          tmp0 += (src[c1] + src[c1 + _LAT_2C_].multi_i()) *
                  U[c1 * _LAT_C_ + c0].conj();
        ...
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp0.multi_i(_negative_, dag, true);
        dest[c0 + _LAT_3C_] += tmp1.multi_i(_positive_, dag, true);
      }
    }
    {
      // z+1
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        for (int c1 = 0; c1 < _LAT_C_; c1++) {
          tmp0 +=
              (src[c1] - src[c1 + _LAT_2C_].multi_i()) * U[c0 * _LAT_C_ + c1];
          tmp1 += (src[c1 + _LAT_1C_] + src[c1 + _LAT_3C_].multi_i()) *
                  U[c0 * _LAT_C_ + c1];
        }
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp0.multi_i(_positive_, dag, true);
        dest[c0 + _LAT_3C_] += tmp1.multi_i(_negative_, dag, true);
      }
    }
  }
#endif
  ...
  { // t part
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_3C_] += tmp1.multi_i(_positive_, dag, false);
      }
    }
    {
      // t+1
    ...
    }
    {
      for (int c0 = 0; c0 < _LAT_C_; c0++) {
        ...
        dest[c0] += tmp0.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_1C_] += tmp1.multi_i(_positive_, dag, false);
        dest[c0 + _LAT_2C_] += tmp0.multi_i(_negative_, dag, false);
        dest[c0 + _LAT_3C_] += tmp1.multi_i(_negative_, dag, false);
      }
    }
  }
#endif
...
__global__ void wilson_dslash_x_recv(void *device_U, void *device_dest,
  ...
  { // x-1
    ...
    for (int c0 = 0; c0 < _LAT_C_; c0++) {
      dest[c0] += b_x_recv_vec[c0].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_1C_] +=
          b_x_recv_vec[c0 + _LAT_1C_].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_2C_] +=
          b_x_recv_vec[c0 + _LAT_1C_].multi_i(_negative_, dag, true);
      dest[c0 + _LAT_3C_] += b_x_recv_vec[c0].multi_i(_negative_, dag, true);
    }
  } // just add
...
__global__ void wilson_dslash_y_recv(void *device_U, void *device_dest,
  ...
  { // y-1
    ...
    for (int c0 = 0; c0 < _LAT_C_; c0++) {
      dest[c0] += b_y_recv_vec[c0].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_1C_] +=
          b_y_recv_vec[c0 + _LAT_1C_].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_2C_] +=
          b_y_recv_vec[c0 + _LAT_1C_].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_3C_] += b_y_recv_vec[c0].multi_i(_negative_, dag, false);
    }
  }
  // just add
...
__global__ void wilson_dslash_z_recv(void *device_U, void *device_dest,
  ...
  { // z-1
    ...
    for (int c0 = 0; c0 < _LAT_C_; c0++) {
      dest[c0] += b_z_recv_vec[c0].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_1C_] +=
          b_z_recv_vec[c0 + _LAT_1C_].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_2C_] += b_z_recv_vec[c0].multi_i(_negative_, dag, true);
      dest[c0 + _LAT_3C_] +=
          b_z_recv_vec[c0 + _LAT_1C_].multi_i(_positive_, dag, true);
    }
  }
  // just add
  add_dest(origin_dest, dest, lat_tzyx);
...
__global__ void wilson_dslash_t_recv(void *device_U, void *device_dest,
  ...
  { // t-1
    ...
    for (int c0 = 0; c0 < _LAT_C_; c0++) {
      dest[c0] += b_t_recv_vec[c0].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_1C_] +=
          b_t_recv_vec[c0 + _LAT_1C_].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_2C_] += b_t_recv_vec[c0].multi_i(_positive_, dag, false);
      dest[c0 + _LAT_3C_] +=
          b_t_recv_vec[c0 + _LAT_1C_].multi_i(_positive_, dag, false);
    }
  }
