...
__global__ void wilson_dslash(void *device_U, void *device_src,
  ...
  const int lat_x = params[_QCU_LAT_X_];
  const int lat_y = params[_QCU_LAT_Y_];
  const int lat_z = params[_QCU_LAT_Z_];
  const int lat_t = params[_QCU_LAT_T_];
  const int lat_tzyx = params[_QCU_LAT_XYZT_];
  int move;
  ...
  int dagger = params[_QCU_DAGGER_];
  ...
  LatticeComplex src[_QCU_LAT_SC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  // just wilson(Sum part)
#ifdef __X__
  {   // x part
    { // x-1
      move_backward_x(move, x, lat_x, eo, parity);
      tmp_U = (origin_U + move + (_QCU_X_ * _QCU_EVEN_ODD_ + (1 - parity)) * lat_tzyx);
    ...
    }
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += (src[c1] + (src[c1 + _QCU_LAT_3C_].flag(dagger)).mult_i()) *
                  U[c1 * _QCU_LAT_C_ + c0].conj();
          tmp1 +=
              (src[c1 + _QCU_LAT_1C_] + (src[c1 + _QCU_LAT_2C_].flag(dagger)).mult_i()) *
              U[c1 * _QCU_LAT_C_ + c0].conj();
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] -= tmp1.mult_i();
        dest[c0 + _QCU_LAT_3C_] -= tmp0.mult_i();
      }
    }
    {
      // x+1
  ...
  {   // y part
    ...
    }
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += (src[c1] - (src[c1 + _QCU_LAT_3C_].flag(dagger))) *
                  U[c1 * _QCU_LAT_C_ + c0].conj();
          tmp1 += (src[c1 + _QCU_LAT_1C_] + (src[c1 + _QCU_LAT_2C_].flag(dagger))) *
                  U[c1 * _QCU_LAT_C_ + c0].conj();
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] += tmp1;
        dest[c0 + _QCU_LAT_3C_] -= tmp0;
      }
    }
    {
      // y+1
  ...
  {   // z part
    ...
    }
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += (src[c1] + (src[c1 + _QCU_LAT_2C_].flag(dagger)).mult_i()) *
                  U[c1 * _QCU_LAT_C_ + c0].conj();
          tmp1 +=
              (src[c1 + _QCU_LAT_1C_] - (src[c1 + _QCU_LAT_3C_].flag(dagger)).mult_i()) *
              U[c1 * _QCU_LAT_C_ + c0].conj();
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] -= tmp0.mult_i();
        dest[c0 + _QCU_LAT_3C_] += tmp1.mult_i();
      }
    }
    {
      // z+1
  ...
  { // t part
    ...
    }
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += (src[c1] + (src[c1 + _QCU_LAT_2C_].flag(dagger))) *
                  U[c1 * _QCU_LAT_C_ + c0].conj();
          tmp1 += (src[c1 + _QCU_LAT_1C_] + (src[c1 + _QCU_LAT_3C_].flag(dagger))) *
                  U[c1 * _QCU_LAT_C_ + c0].conj();
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] += tmp0;
        dest[c0 + _QCU_LAT_3C_] += tmp1;
      }
    }
    {
      // t+1
...
__global__ void wilson_dslash_inside(void *device_U, void *device_src,
  ...
  {   // x part
    ...
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_ * (move != lat_x - 1);
           c0++) { // just inside
        tmp0 = zero;
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
    ...
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_ * (move != 1 - lat_x);
           c0++) { // just inside
        tmp0 = zero;
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
  ...
  {   // y part
    ...
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_ * (move == -1); c0++) { // just inside
        tmp0 = zero;
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += (src[c1] - (src[c1 + _QCU_LAT_3C_].flag(dagger))) *
...
__global__ void wilson_dslash_x_send(void *device_U, void *device_src,
  ...
  LatticeComplex src[_QCU_LAT_SC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_x_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_x_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex *origin_U;
  LatticeComplex *origin_src;
  LatticeComplex *origin_b_x_send_vec;
  LatticeComplex *origin_f_x_send_vec;
  {
    lat_x = params[_QCU_LAT_X_]; // give lat_size back
    x = 0;                   // b_x
  ...
  { // x-1
    ...
    { // sigma src
      for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
        b_x_send_vec[c1] = src[c1] - (src[c1 + _QCU_LAT_3C_].flag(dagger)).mult_i();
        b_x_send_vec[c1 + _QCU_LAT_1C_] =
            src[c1 + _QCU_LAT_1C_] - (src[c1 + _QCU_LAT_2C_].flag(dagger)).mult_i();
      }
  ...
  { // x+1
    ...
    // send in x-1 way
    tmp_U =
        (origin_U + (_QCU_X_ * _QCU_EVEN_ODD_ + (1 - parity)) * lat_tzyx); // even-odd
    give_u(U, tmp_U, lat_tzyx);
    give_src(src, origin_src, lat_tzyx);
    { // just tmp
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        f_x_send_vec[c0 + _QCU_LAT_1C_] = tmp1;
      }
...
__global__ void wilson_dslash_x_recv(void *device_U, void *device_dest,
  ...
  LatticeComplex U[_QCU_LAT_CC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_x_recv_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_x_recv_vec[_QCU_LAT_HALF_SC_]; // needed
  LatticeComplex *origin_U;
  LatticeComplex *origin_dest;
  ...
  { // x-1
    ...
    for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
      ...
      dest[c0 + _QCU_LAT_1C_] += b_x_recv_vec[c0 + _QCU_LAT_1C_];
      dest[c0 + _QCU_LAT_2C_] -= b_x_recv_vec[c0 + _QCU_LAT_1C_].mult_i();
      dest[c0 + _QCU_LAT_3C_] -= b_x_recv_vec[c0].mult_i();
    }
  } // just add
  ...
  { // x+1
    ...
    give_u(U, tmp_U, lat_tzyx);
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += f_x_recv_vec[c1] * U[c0 * _QCU_LAT_C_ + c1];
          tmp1 += f_x_recv_vec[c1 + _QCU_LAT_1C_] * U[c0 * _QCU_LAT_C_ + c1];
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] += tmp1.mult_i();
...
__global__ void wilson_dslash_y_send(void *device_U, void *device_src,
  ...
  LatticeComplex src[_QCU_LAT_SC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_y_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_y_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex *origin_U;
  LatticeComplex *origin_src;
  LatticeComplex *origin_b_y_send_vec;
  LatticeComplex *origin_f_y_send_vec;
  {
    lat_y = params[_QCU_LAT_Y_]; // give lat_size back
    y = 0;                   // b_y
    origin_src = ((static_cast<LatticeComplex *>(device_src)) +
                  (((t * lat_z + z) * lat_y + y) * lat_x + x));
    origin_b_y_send_vec =
  ...
  { // y-1
    ...
    { // sigma src
      for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
        b_y_send_vec[c1] = src[c1] + (src[c1 + _QCU_LAT_3C_].flag(dagger));
        b_y_send_vec[c1 + _QCU_LAT_1C_] =
            src[c1 + _QCU_LAT_1C_] - (src[c1 + _QCU_LAT_2C_].flag(dagger));
      }
  ...
  { // y+1
    ...
    // send in y-1 way
    tmp_U =
        (origin_U + (_QCU_Y_ * _QCU_EVEN_ODD_ + (1 - parity)) * lat_tzyx); // even-odd
    give_u(U, tmp_U, lat_tzyx);
    give_src(src, origin_src, lat_tzyx);
    { // just tmp
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        f_y_send_vec[c0 + _QCU_LAT_1C_] = tmp1;
      }
...
__global__ void wilson_dslash_y_recv(void *device_U, void *device_dest,
  ...
  LatticeComplex U[_QCU_LAT_CC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_y_recv_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_y_recv_vec[_QCU_LAT_HALF_SC_]; // needed
  LatticeComplex *origin_U;
  LatticeComplex *origin_dest;
  ...
  { // y-1
    ...
    for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
      ...
      dest[c0 + _QCU_LAT_1C_] += b_y_recv_vec[c0 + _QCU_LAT_1C_];
      dest[c0 + _QCU_LAT_2C_] += b_y_recv_vec[c0 + _QCU_LAT_1C_];
      dest[c0 + _QCU_LAT_3C_] -= b_y_recv_vec[c0];
    }
  }
  // just add
  ...
  { // y+1
    ...
    give_u(U, tmp_U, lat_tzyx);
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += f_y_recv_vec[c1] * U[c0 * _QCU_LAT_C_ + c1];
          tmp1 += f_y_recv_vec[c1 + _QCU_LAT_1C_] * U[c0 * _QCU_LAT_C_ + c1];
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] -= tmp1;
...
__global__ void wilson_dslash_z_send(void *device_U, void *device_src,
  ...
  LatticeComplex src[_QCU_LAT_SC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_z_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_z_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex *origin_U;
  LatticeComplex *origin_src;
  LatticeComplex *origin_b_z_send_vec;
  LatticeComplex *origin_f_z_send_vec;
  {
    lat_z = params[_QCU_LAT_Z_]; // give lat_size back
    z = 0;                   // b_z
    origin_src = ((static_cast<LatticeComplex *>(device_src)) +
                  (((t * lat_z + z) * lat_y + y) * lat_x + x));
    origin_b_z_send_vec =
  ...
  { // z-1
    ...
    { // sigma src
      for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
        b_z_send_vec[c1] = src[c1] - (src[c1 + _QCU_LAT_2C_].flag(dagger)).mult_i();
        b_z_send_vec[c1 + _QCU_LAT_1C_] =
            src[c1 + _QCU_LAT_1C_] + (src[c1 + _QCU_LAT_3C_].flag(dagger)).mult_i();
      }
  ...
  { // z+1
    ...
    // send in z-1 way
    tmp_U =
        (origin_U + (_QCU_Z_ * _QCU_EVEN_ODD_ + (1 - parity)) * lat_tzyx); // even-odd
    give_u(U, tmp_U, lat_tzyx);
    give_src(src, origin_src, lat_tzyx);
    { // just tmp
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        f_z_send_vec[c0 + _QCU_LAT_1C_] = tmp1;
      }
...
__global__ void wilson_dslash_z_recv(void *device_U, void *device_dest,
  ...
  LatticeComplex U[_QCU_LAT_CC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_z_recv_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_z_recv_vec[_QCU_LAT_HALF_SC_]; // needed
  LatticeComplex *origin_U;
  LatticeComplex *origin_dest;
  ...
  { // z-1
    ...
    for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
      ...
      dest[c0 + _QCU_LAT_1C_] += b_z_recv_vec[c0 + _QCU_LAT_1C_];
      dest[c0 + _QCU_LAT_2C_] -= b_z_recv_vec[c0].mult_i();
      dest[c0 + _QCU_LAT_3C_] += b_z_recv_vec[c0 + _QCU_LAT_1C_].mult_i();
    }
  }
  // just add
  add_dest(origin_dest, dest, lat_tzyx);
  ...
  { // z+1
    ...
    give_u(U, tmp_U, lat_tzyx);
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += f_z_recv_vec[c1] * U[c0 * _QCU_LAT_C_ + c1];
          tmp1 += f_z_recv_vec[c1 + _QCU_LAT_1C_] * U[c0 * _QCU_LAT_C_ + c1];
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] += tmp0.mult_i();
...
__global__ void wilson_dslash_t_send(void *device_U, void *device_src,
  ...
  LatticeComplex src[_QCU_LAT_SC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_t_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_t_send_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex *origin_U;
  LatticeComplex *origin_src;
  LatticeComplex *origin_b_t_send_vec;
  LatticeComplex *origin_f_t_send_vec;
  {
    lat_t = params[_QCU_LAT_T_]; // give lat_size back
    t = 0;                   // b_t
    origin_src = ((static_cast<LatticeComplex *>(device_src)) +
                  (((t * lat_z + z) * lat_y + y) * lat_x + x));
    origin_b_t_send_vec =
  ...
  { // t-1
    ...
    { // sigma src
      for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
        b_t_send_vec[c1] = src[c1] - (src[c1 + _QCU_LAT_2C_].flag(dagger));
        b_t_send_vec[c1 + _QCU_LAT_1C_] =
            src[c1 + _QCU_LAT_1C_] - (src[c1 + _QCU_LAT_3C_].flag(dagger));
      }
  ...
  { // t+1
    ...
    // send in t-1 way
    tmp_U =
        (origin_U + (_QCU_T_ * _QCU_EVEN_ODD_ + (1 - parity)) * lat_tzyx); // even-odd
    give_u(U, tmp_U, lat_tzyx);
    give_src(src, origin_src, lat_tzyx);
    { // just tmp
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        f_t_send_vec[c0 + _QCU_LAT_1C_] = tmp1;
      }
...
__global__ void wilson_dslash_t_recv(void *device_U, void *device_dest,
  ...
  LatticeComplex U[_QCU_LAT_CC_];
  LatticeComplex dest[_QCU_LAT_SC_];
  LatticeComplex b_t_recv_vec[_QCU_LAT_HALF_SC_];
  LatticeComplex f_t_recv_vec[_QCU_LAT_HALF_SC_]; // needed
  LatticeComplex *origin_U;
  LatticeComplex *origin_dest;
  ...
  { // t-1
    ...
    for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
      ...
      dest[c0 + _QCU_LAT_1C_] += b_t_recv_vec[c0 + _QCU_LAT_1C_];
      dest[c0 + _QCU_LAT_2C_] += b_t_recv_vec[c0];
      dest[c0 + _QCU_LAT_3C_] += b_t_recv_vec[c0 + _QCU_LAT_1C_];
    }
  }
  // just add
  add_dest(origin_dest, dest, lat_tzyx);
  ...
  { // t+1
    ...
    give_u(U, tmp_U, lat_tzyx);
    {
      for (int c0 = 0; c0 < _QCU_LAT_C_; c0++) {
        ...
        tmp1 = zero;
        for (int c1 = 0; c1 < _QCU_LAT_C_; c1++) {
          tmp0 += f_t_recv_vec[c1] * U[c0 * _QCU_LAT_C_ + c1];
          tmp1 += f_t_recv_vec[c1 + _QCU_LAT_1C_] * U[c0 * _QCU_LAT_C_ + c1];
        }
        dest[c0] += tmp0;
        dest[c0 + _QCU_LAT_1C_] += tmp1;
        dest[c0 + _QCU_LAT_2C_] -= tmp0;
