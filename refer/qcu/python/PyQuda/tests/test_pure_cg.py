...
def test_mpi(round):
  ...
  t1 = perf_counter()
  #qcu.cg_inverter(p.even_ptr, x_vector.even_ptr, U.data_ptr, param) # Dslash x_vector = Mp1, get x_vector
  qcu.cg_inverter(x_vector.even_ptr, p.even_ptr, U.data_ptr, param, 1e-8, 0.125) # Dslash x_vector = Mp1, get x_vector
  t2 = perf_counter()
