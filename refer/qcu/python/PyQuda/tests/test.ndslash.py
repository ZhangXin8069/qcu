...
def test_mpi(round):
  ...
  #arr = cp.zeros([Lt, Lz, Ly, Lx, Ns, Nc], dtype=cp.complex128)
  #arr[0, 0, 0, 0, 0, 0] = 1
  
  #p = LatticeFermion(latt_size, arr) # cp.zeros(Lt, Lz, Ly, Lx, Ns, Nc * 2).view(cp.complex128))
  ...
  #dslash.invert_param.dagger = 1 # DAGGER_YES
...
#  cp.cuda.runtime.deviceSynchronize()
  ...
  # print(f'Quda res[1, 1, 1, 1] = \n {Mp.data[0, 1, 1, 1, 1]}')
  # print(f'Qcu res[1, 1, 1, 1] = \n {Mp1.data[0, 1, 1, 1, 1]}')

  #print(f'Quda res[0, 0, 0, 1] = \n {Mp.data[1, 0, 0, 0, 0]}')
  #print(f'Qcu res[0, 0, 0, 1] = \n {Mp1.data[1, 0, 0, 0, 0]}')
