...
int main()
{
  ...
  { // io
    ...
    filename << "wilson-dslash-gauge_-32-32-32-32-1048576-1-1-1-1-0-0-1-0-f.bin";
    ...
    { // fermion_out
      std::stringstream filename;
      // filename << "wilson-dslash-fermion-out_-32-32-32-32-1048576-1-1-1-1-0-0-1-0-f.bin";
    ...
    { // fermion_in
      std::stringstream filename;
      filename << "wilson-dslash-fermion-in_-32-32-32-32-1048576-1-1-1-1-0-0-1-0-f.bin";
      cudaDeviceSynchronize();
  ...
  { // io
    std::stringstream filename;
    filename << "_wilson-dslash-fermion-out_-32-32-32-32-1048576-1-1-1-1-0-0-1-0-f.bin";
