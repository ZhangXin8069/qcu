  ...
  void _make(void *gauge, int parity) {
    ...
    // edge send part
    {
      ...
      pick_up_u_x<<<set_ptr->gridDim_3dim[_X_], set_ptr->blockDim, 0,
          ...
          gauge, set_ptr->device_u_1dim_send_vec, set_ptr->device_lat_xyzt,
          parity);
    ...
    //       gauge, set_ptr->device_u_2dim_send_vec, set_ptr->device_lat_xyzt,
    //       parity);
    ...
    //              set_ptr->lat_3dim[_X_] * _LAT_DCC_ * _REAL_IMAG_,
    ...
    //              set_ptr->lat_3dim[_Y_] * _LAT_DCC_ * _REAL_IMAG_,
    ...
    //              set_ptr->lat_3dim[_Z_] * _LAT_DCC_ * _REAL_IMAG_,
    ...
    //              set_ptr->lat_3dim[_T_] * _LAT_DCC_ * _REAL_IMAG_,
    ...
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_X_B_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_F_X_F_Z_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _XZ_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_X_F_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    //     ncclSend(set_ptr->device_u_2dim_send_vec[_F_X_B_Z_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _XZ_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_X_B_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_B_X_F_Z_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _XZ_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_X_F_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    ...
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_X_B_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_F_X_F_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _XT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_X_F_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    //     ncclSend(set_ptr->device_u_2dim_send_vec[_F_X_B_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _XT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_X_B_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_B_X_F_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _XT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_X_F_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    ...
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_Y_B_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_F_Y_F_Z_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _YZ_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_Y_F_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    //     ncclSend(set_ptr->device_u_2dim_send_vec[_F_Y_B_Z_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _YZ_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_Y_B_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_B_Y_F_Z_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _YZ_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_Y_F_Z_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    ...
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_Y_B_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_F_Y_F_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _YT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_Y_F_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    //     ncclSend(set_ptr->device_u_2dim_send_vec[_F_Y_B_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _YT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_Y_B_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_B_Y_F_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _YT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_Y_F_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    ...
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_Z_B_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_F_Z_F_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _ZT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_Z_F_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_a_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
    //     ncclSend(set_ptr->device_u_2dim_send_vec[_F_Z_B_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _ZT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_F_Z_B_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclRecv(set_ptr->device_u_2dim_recv_vec[_B_Z_F_T_],
    //              set_ptr->lat_2dim[_2DIM_ - 1 - _ZT_] * _LAT_DCC_ *
    //              _REAL_IMAG_, ncclDouble, set_ptr->move_wards[_B_Z_F_T_],
    //              set_ptr->nccl_comm, set_ptr->stream_dims[_b_]);
    //     ncclGroupEnd();
    //     ncclGroupStart();
